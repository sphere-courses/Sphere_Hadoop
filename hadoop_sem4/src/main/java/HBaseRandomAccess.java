...
public class HBaseRandomAccess {
    ...
    void DemoPut() throws IOException {
        ...
        put.addColumn(Bytes.toBytes("cf1"), Bytes.toBytes("owner"), Bytes.toBytes("Bill Gates"));
        put.addColumn(Bytes.toBytes("cf1"), Bytes.toBytes("last_updated"), Bytes.toBytes(1478039132000L));
        table.put(put);
